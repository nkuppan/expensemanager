...
public fun ApplicationExtension.configureAndroidAppVersion() {
    defaultConfig {
...
public fun Project.configureAndroidCompose(extension: CommonExtension<*, *, *, *, *>) {
...
public fun CommonExtension<*, *, *, *, *>.configureBuildFeatures() {
