...
import com.nkuppan.expensemanager.databinding.AdapterCategoryTransactionItemBinding
import com.nkuppan.expensemanager.databinding.AdapterGraphItemBinding
import com.nkuppan.expensemanager.databinding.AdapterHeadingItemBinding
                ...
                (holder as HeadingItemViewHolder).binding.apply {
                    title.setText(
                        if (data.categoryType == CategoryType.INCOME)
                            com.nkuppan.expensemanager.R.string.income
                        else
                            com.nkuppan.expensemanager.R.string.expense
                    )
