...
class AccountRepositoryImplTest : com.naveenapps.expensemanager.common.testing.BaseCoroutineTest() {
    ...
    fun checkInsertSuccessCase() = runTest {
        val result =
            accountRepository.addAccount(FAKE_ACCOUNT)
    ...
    fun checkDeleteSuccessCase() = runTest {
        ...
        result =
            accountRepository.deleteAccount(FAKE_ACCOUNT)
        Truth.assertThat(result).isNotNull()
        Truth.assertThat(result).isInstanceOf(Resource.Success::class.java)
    ...
    fun checkFindByIdSuccessCase() = runTest {
        ...
        Truth.assertThat(foundData.id)
            .isEqualTo(FAKE_ACCOUNT.id)
    }
